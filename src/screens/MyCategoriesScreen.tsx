...
const MyCategoriesScreen = () => {
    ...
    // Generate a unique list of categories, extracting the short name
    const uniqueCategories = useMemo(() => {
        ...
        inRangeProducts.forEach((product) => {
            ...
            if (fullPath && !categoriesMap.has(fullPath)) {
                ...
                const imageUrl = firstImageProduct?.images?.[0] || "https://via.placeholder.com/150";

                categoriesMap.set(fullPath, {
                    fullPath: fullPath,
                    name: getCategoryName(fullPath), // Using the corrected helper
                    imageUrl,
                });
            }
        });
    ...
    // Automatically select the first category when the list is populated
    useEffect(() => {
    ...
    // Filter and sort products based on the selected category and sort order
                        ...
                        <View style={styles.filterContainer}>
                            ...
                            >
                                <Ionicons
                                    name="arrow-up"
                                    size={14}
                                    color={sortOrder === "asc" ? Colors.textLight : Colors.textDarkBrown}
                                />
                                <Text
                                    style={[
                                        styles.filterText,
                            ...
                            >
                                <Ionicons
                                    name="arrow-down"
                                    size={14}
                                    color={sortOrder === "desc" ? Colors.textLight : Colors.textDarkBrown}
                                />
                                <Text
                                    style={[
                                        styles.filterText,
